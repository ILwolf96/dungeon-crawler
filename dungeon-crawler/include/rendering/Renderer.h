...
namespace dungeon
{
    ...
    private: //--------------------------------------------------------------------------------Private Starts HERE!
        ...
        // Camera dead-zone anchors inside the fixed 26x26 temporary-tile viewport.
        static constexpr int CameraDeadZoneLeft = 8;
        static constexpr int CameraDeadZoneRight = 17;
        static constexpr int CameraDeadZoneBottom = 8;
        static constexpr int CameraDeadZoneTop = 17;
        ...
        mutable int m_mapCameraX{ 0 };
        mutable int m_mapCameraY{ 0 };
        mutable bool m_mapCameraInitialized{ false };
        mutable int m_lastCameraMapWidth{ 0 };
        mutable int m_lastCameraMapHeight{ 0 };
